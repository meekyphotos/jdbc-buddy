...
import com.experive.buddy.Asterisk
...
import com.experive.buddy.steps.InsertOnDuplicateStep
import com.experive.buddy.steps.InsertResultStep
import com.experive.buddy.steps.InsertReturningStep
...
internal class InsertQueryBuilder<R : Any>(
    ...
    override fun values(vararg values: Any?): InsertValuesStep<R> {
        ...
        records.add(
            this.columns.mapIndexed { index, _ ->
