...
internal class H2CoreDatabaseTest : DatabaseCoreQueries() {
  ...
  internal fun setUp() {
    ...
    underTest.execute("create table if not exists date_entity (id int primary key auto_increment, local_time_field time, local_date_field date, local_date_time_field timestamp, java_date_field timestamp, java_timestamp_field timestamp)")
